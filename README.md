...
API de Practica Git Flow para estudiantes
...
Tienes que correr el siguiente link en el navegador.
~~~bash
curl http://localhost:3000/api/estado
~~~

Respuesta esperada:
Esta es la respuesta que se espera del backend
~~~json
{
  "ok": true,
